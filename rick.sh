...
yad --notification --image=./rick.png --text "Never gonna give you up!" --command "xfce4-terminal --title=Rick\ Roll --hide-menubar --hide-scrollbar -e './roll.sh'" --listen <&3 & notifpid=$!
